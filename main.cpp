        ...
        cin >> choice;
         switch (choice) 
         {
            case 1:
               ...
               // objects[count]=ptr1;
                objects[count] = new Rectangle(width, lenght);
                count++;
                break;
            case 2:
               // float diagH=0;
               // float diagV=0;
                ...
                //objects[count] = ptr2;
                objects[count] = new Rhombus(diagH, diagV);
                count++;
                break;
            case 3:
               ...
               // objects[count]=ptr3;
                objects[count] = new IsoTrapezoid(bottomside, topside, height);
                count++;
                break;
            case 4:
